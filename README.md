...
This repo contains the same SDLC model shown through 3 perspectives ("views"), each with 3 zoom levels (HIGH / MID / LOW).

## Views

Each view contains 3 Mermaid diagrams:

- [Perspective 1: Work Flow](views/01-work-flow.md)
- [Perspective 2: People & AI](views/02-people-ai.md)
- [Perspective 3: Governance](views/03-governance.md)
